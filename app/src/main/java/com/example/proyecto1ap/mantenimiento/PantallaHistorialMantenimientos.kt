...
private fun DialogoTipo(
    ...
    AlertDialog(
        ...
        text = {
            Column {
                listOf(null to "Todos", TipoMantenimiento.PREVENTIVO to "Preventivo", TipoMantenimiento.CORRECTIVO to "Correctivo")
        ...
        Column(
            ...
            Row(
                ...
                FilterChip(
                    ...
                    label = {
                        Text(
                            if (s.filtroTipo == null) "Tipo: Todos" else "Tipo: ${s.filtroTipo!!.etiqueta}",
                            fontSize = 13.sp
                        )
                    },
            ...
            if (s.cargando) {
            ...
            } else if (s.registrosFiltrados.isEmpty()) {
                Box(
                    Modifier
                        .fillMaxSize()
                        .padding(32.dp),
                ...
                LazyColumn(
                    ...
                    items(s.registrosFiltrados, key = { it.id }) { registro ->
                        TarjetaRegistroMantenimiento(registro = registro)
                    }
                }
            }
        }
